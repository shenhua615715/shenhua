...
public class FileUtils extends org.apache.commons.io.FileUtils {
	...
	public static void downFile(String fileName,String fileType,HttpServletResponse response) throws Exception{
		Exception e = null;
		InputStream fis=null;
		OutputStream toClient=null;
		 try {
	            String pathName=null;
	            if(Constant.FILE_TYPE_EXCEL.equals(fileType)){
	            	pathName = Constant.FILE_EXCEL_PATH+fileName ;
		            ...
		            response.reset();
		            // 设置response的Header
		            response.addHeader("Content-Disposition", "attachment;filename=" + new String(URLEncoder.encode(fileName, "UTF-8").getBytes()));
...
public static void downFile(String filePath,String fileName,String fileType,HttpServletResponse response){
	...
	private static void unrar(String sourceRar,String destDir) throws Exception{
		File ff = new File(sourceRar);
		unrar(ff,destDir);
	}
	private static void unrar(File ff,String destDir) throws Exception{
		Archive a = null;
		FileOutputStream fos = null;
		try{
			a = new Archive(new NativeStorage(ff));
	...
	public static void deCompress(String sourceFile,String destDir) throws Exception{
		...
		if(type.equals("zip")){
			FileUtils.unZipFiles(sourceFile, destDir);
		}else if(type.equals("rar")){
			FileUtils.unrar(sourceFile, destDir);
		}else{
	...
	public static void main(String[] args){
		try {
			deCompress("C:\\Users\\liuye\\Desktop\\guanggao.rar","C:\\Users\\liuye\\Desktop\\liuyetest");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
