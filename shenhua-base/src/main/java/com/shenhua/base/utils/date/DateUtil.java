package com.shenhua.base.utils.date;
...
public class DateUtil {
    ...
    public static void main(String args[]){
        ...
        Date d1 = new Date();
        Date d2 = getDayEndTime(d1);
        Date d3 = getDayStartTime(d1);
        Calendar cal = Calendar.getInstance();
        System.out.println(DateToString(cal.getTime(), DateStyle.YYYY_MM_DD_HH_MM_SS));
        System.out.println(DateToString(d2, DateStyle.YYYY_MM_DD_HH_MM_SS));
        System.out.println(DateToString(d3, DateStyle.YYYY_MM_DD_HH_MM_SS));
        ...
        System.out.println("getDayStartTime = " + DateUtil.getDayStartTime(new Date()));
        System.out.println("getDayEndTime = " + DateUtil.getDayEndTime(new Date()));
        System.out.println("getDayStartTime.getTime() = " + DateUtil.getDayStartTime(new Date()).getTime());
        System.out.println("getDayEndTime.getTime() = " + DateUtil.getDayEndTime(new Date()).getTime());
        System.out.println("d1.getTime() = " + (DateUtil.getDayEndTime(new Date()).getTime() - DateUtil.getDayStartTime(new Date()).getTime()+1));

        try {
            System.out.println("a = " + DateUtil.getCorrectDateOnEntire(d1,DateStyle.YYYY_MM_DD_HH_MM.getValue()));
    ...
    //    big2 = big2.setScale(2,BigDecimal.ROUND_DOWN);
       // System.out.println("big2 = " + big2);
      //  System.out.println("big2.add(big1) = " + big2.add(big1));
        System.out.println("big1 = " + big1.add(big2.setScale(2,BigDecimal.ROUND_DOWN)));
    }
}